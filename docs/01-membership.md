...
| **Robust Incentive Group (RIG)** (6 contributors) | **6** | |
...
| **Stateless Consensus** (3 contributors) | **2.5** | |
...
| **Group** | **Weight** | **Contributions** |
|:---|:---|:---|
| **Execution Layer Specs + Coordination** (8 contributors) | **8** | |
