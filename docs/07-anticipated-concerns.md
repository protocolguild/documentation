...
- As discussed in "[2. Tradeoffs of Existing Mechanisms](https://protocol-guild.readthedocs.io/en/latest/02-existing-mechanisms.html#tradeoffs-of-existing-mechanisms)," traditional orgs will never be able to match the upside that comes from working on a novel tokenized application or L2.
